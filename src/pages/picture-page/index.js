  ...
  return (
    <Box sx={{ width: '100%' }}>
      <Alert severity="success">
        <h3 style={{ margin: '0', color: 'white' }}>Authorization period is until 12/24/2023</h3>
      </Alert>
      <Stack justifyContent="center" spacing={2}>
        <Item>
          <TextField
            ...
            label="Prompt"
            helperText="Please enter prompt"
            variant="standard"
          ...
          <TextField
            ...
            helperText="Please enter negative prompt"
            variant="standard"
        ...
        <Item1>
          <Box sx={{ margin: '20px 30vw 20px 30vw' }}>
            <Card sx={{ maxWidth: 400 }}>
              <CardMedia sx={{ height: 400 }} image={url_data.images} title="green iguana" />
              <CardActions>
