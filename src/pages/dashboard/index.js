        ...
        <Item>
          <Stack direction="row" spacing={5} justifyContent="center" alignItems="center">
            <div style={{ marginTop: '20px ' }}>
              <Avatar alt="" src={require('../../assets/images/16.jpg')} sx={{ width: 100, height: 100 }} />
            </div>
          </Stack>
          <Stack direction="row" spacing={5} justifyContent="left" alignItems="center">
            <div style={{ marginTop: '20px ' }}>
              ...
              <TextField required id="outlined-required" label="Company" sx={{ width: '20vw' }} />
            </div>
            <div style={{ marginTop: '20px ' }}>
              <AccountCircle sx={{ color: 'action.active', mr: 1, my: 0.5 }} />
              <TextField required id="outlined-required" label="Username" sx={{ width: '20vw' }} />
            </div>
            <div style={{ marginTop: '20px ' }}>
              <EmailRoundedIcon sx={{ color: 'action.active', mr: 1, my: 0.5 }} />
              <TextField required id="outlined-required" label="Email Address" sx={{ width: '20vw' }} />
            </div>
          </Stack>
          <Stack direction="row" spacing={5} justifyContent="left" alignItems="center">
            <div style={{ marginTop: '20px ' }}>
              <PersonPinCircleRoundedIcon sx={{ color: 'action.active', mr: 1, my: 0.5 }} />
              <TextField required id="outlined-required" label="First name" sx={{ width: '20vw' }} />
            </div>
            <div style={{ marginTop: '20px ' }}>
              <PersonPinCircleRoundedIcon sx={{ color: 'action.active', mr: 1, my: 0.5 }} />
              <TextField required id="outlined-required" label="Last name" sx={{ width: '20vw' }} />
            </div>
          </Stack>
          <Stack direction="row" spacing={5} justifyContent="left" alignItems="center">
            <div style={{ marginTop: '20px ' }}>
              <ContactsRoundedIcon sx={{ color: 'action.active', mr: 1, my: 0.5 }} />
              <TextField required id="outlined-required" label="Address" sx={{ width: '20vw' }} />
            </div>
          </Stack>
          <Stack direction="row" spacing={5} justifyContent="left" alignItems="center">
            <div style={{ marginTop: '20px ' }}>
              <LocationCityRoundedIcon sx={{ color: 'action.active', mr: 1, my: 0.5 }} />
              <TextField required id="outlined-required" label="City" sx={{ width: '20vw' }} />
            </div>
            <div style={{ marginTop: '20px ' }}>
              <PublicRoundedIcon sx={{ color: 'action.active', mr: 1, my: 0.5 }} />
              <TextField required id="outlined-required" label="Country" sx={{ width: '20vw' }} />
            </div>
            <div style={{ marginTop: '20px ' }}>
              <MarkAsUnreadIcon sx={{ color: 'action.active', mr: 1, my: 0.5 }} />
              <TextField required id="outlined-required" label="Postal Code" sx={{ width: '20vw' }} />
            </div>
          </Stack>
          <Stack direction="row" spacing={5} justifyContent="center" alignItems="center">
            <div style={{ marginTop: '20px ' }}>
